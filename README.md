...
쳐 breast_cancer.csv           # Dataset 
쳐 train_5feature_model.py     # Script to train model and scaler 
쳐 model_accuracy_save_plot.py # Script to evaluate model 
쳐 logistic_model.pkl          # Saved Logistic Regression model 
쳐 scaler.pkl                  # Saved StandardScaler 
쳐 static/                     # Folder for static files (optional for Flask) 
쳐 templates/                  # Flask HTML templates (optional) 
읕 README.md 
``` 
